...
Status.create(status: "Esperando aprobación de Profesor")
...
Project.create(
	...
	abstract_problem:"El Proyecto de Monitoreo estadístico en tiempo real para proveedores busca mejorar los sistemas actuales de inspección-recibo de la empresa mediante la implementación de un sistema electrónico de monitoreo, este sistema presenta una innovación a las normas de control estadístico de procesos que menciona la norma IATF:16949.
