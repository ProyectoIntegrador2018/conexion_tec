...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { department: @professor.department, email: @professor.email, enrollment: @professor.enrollment } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { department: @professor.department, email: @professor.email, enrollment: @professor.enrollment } }
